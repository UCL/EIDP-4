...
/**
 * <p>Java class for method-type complex type.
 * 
 ...
 *         &lt;element name="order" type="{}method-order-type" minOccurs="0"/>
 *       &lt;/sequence>
...
public class MethodType {
    ...
    @XmlElement(name = "for")
    protected List<MethodForType> _for;
    protected MethodOrderType order;
    ...
    public List<MethodForType> getFor() {
        if (_for == null) {
            _for = new ArrayList<MethodForType>();
        }
        return this._for;
    }
     ...
     * @return
     *     possible object is
     *     {@link MethodOrderType }
     *     
     */
    public MethodOrderType getOrder() {
        return order;
    }
     ...
     *     
     */
    public void setOrder(MethodOrderType value) {
        this.order = value;
    }
