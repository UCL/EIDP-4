...
create table UCLBRIT.T_USERS (id INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 10, INCREMENT BY 1), login VARCHAR(50) NOT NULL, password VARCHAR(100) NOT NULL, login_err_number INTEGER, login_err_timestamp VARCHAR(80) NOT NULL, create_timestamp VARCHAR(80), modify_timestamp VARCHAR(80), center_id INTEGER NOT NULL);
